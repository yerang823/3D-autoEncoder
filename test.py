...
import os
from data_process import stack_mat
...
train_data,test_data,val_data=stack_mat()
...
autoencoder = load_model('../result/model/autoencoder_64x64x64_norm_noise.h5')
...
save_path='../result/npy/test_pred_noise.npy'
